        ...
        <div class="container">
            <div class="motto text-center mt-2">
                <div class="card" style="background-color: transparent;">
                    ...
                    <div class="col-lg-12">
                        <a href="" class="btn btn-link text-success btn-large btn-round"> Mais informações <i
                                class="fa fa-plus"></i> </a>
                        @can('isAdmin')
                        <a href="{{route('match.index')}}" class="btn btn-link btn-danger btn-round"> Agende uma Partida<i
                                class="fa fa-key"></i> </a>
                        @endcan
                        ...
                        <a href="{{route('leagues.index')}}" class="btn btn-link btn-success btn-large btn-round"> Ver
                            as ligas<i class="fa fa-eye"></i> </a>
                        <a href="{{route('times.index')}}" class="btn btn-link btn-danger btn-large btn-round"> Ver os
                            Times<i class="fa fa-users"></i> </a>
                        <a href="{{route('rankings.index')}}" class="btn btn-link btn-success  btn-large btn-round"> Ver
                            o Ranking Mundial<i class="fa fa-users"></i> </a>
                    </div>
                </div>
            </div>
        </div>
